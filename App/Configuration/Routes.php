...
Router::addRoute('^/?static_page/(?P<action>[a-zA-Z0-9_]+)/?$', ['controller' => 'static_page']);
Router::addRoute('^/?static_page/(?P<name>[a-zA-Z0-9_]+)/?$', ['controller' => 'static_page', 'action' => 'index']);
