<div class="modal_window_content">
        ...
        <div class="authorization_right">
            <img onclick="HideAuthorization()" src="/images/engine_images/cancel.png" class="window_close" alt="Закрыть">
            <div class="authorization_container">
...
<script type="text/javascript" src="/App/AJAX/Authorization.js"></script>
