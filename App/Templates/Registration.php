<div class="modal_window_content">
    <div class="authorization_right">
        <div class="authorization_container">
            <img src="/images/engine_images/book_logo.png">
        </div>
    </div>
    <div class="authorization_left">
        <img onclick="HideRegistration()" src="/images/engine_images/cancel.png" class="window_close" alt="Закрыть">
        <div class="authorization_container">
...
<script type="text/javascript" src="/App/AJAX/Registration.js"></script>